...
const counselHistory = ref([
  { id: 1, date: '2024-01-12', recipientName: '김영희', status: '완료' },
  { id: 2, date: '2024-01-08', recipientName: '이순자', status: '완료' }
]);
</script>
      ...
      <div class="tab-content">
        ...
        <div v-else class="history-section">
          ...
          <div class="history-list">
            <div v-for="item in counselHistory" :key="item.id" class="history-card">
              <div class="card-info">
                <div class="info-row">
